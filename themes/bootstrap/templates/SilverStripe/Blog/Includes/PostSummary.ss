<article class="post-summary p-4 p-lg-4 mb-3 border overflow-auto bg-light" aria-label="$Title">
    <% if $Photo %>
        <div class="post-summary__media ml-md-5 mb-3 mb-lg-0 ml-sm-3 ">
            <a href="$Link">
                <img src="$Photo.Fill(400,300).URL" class="post-summary__img img-fluid img-thumbnail" alt="$Title" loading="lazy" />
            </a>
        </div>
    <% end_if %>
